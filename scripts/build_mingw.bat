@echo off
g++ -c -DVST_FORCE_DEPRECATED=0 -DGUI -DUNICODE -D_UNICODE -D_WIN32_WINNT=0x0400 -I..\VST2_SDK -O3 ..\dsp\*.cpp ..\fmopl3lib\*.cpp ..\src\*.cpp ..\synthlib_apogee\*.cpp ..\synthlib_doom\*.cpp ..\synthlib_w9x\*.cpp ..\VST2_SDK\public.sdk\source\vst2.x\*.cpp
