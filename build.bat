...
cl /nologo -c /D _CRT_SECURE_NO_DEPRECATE /D VST_FORCE_DEPRECATED=0 /D demo /I ".\include\msinttypes" /I ".\VST2_SDK" dsp\*.cpp fmopl3lib\*.cpp src\*.cpp synthlib_apogee\*.cpp synthlib_doom\*.cpp synthlib_w9x\*.cpp VST2_SDK\public.sdk\source\vst2.x\*.cpp
link audioeffect.obj audioeffectx.obj vstplugmain.obj main.obj midiprog.obj OPL3GM.obj OPL3GM_proc.obj queue.obj DCFilter.obj resampler.obj opl.obj opl3.obj opl3class.obj al_midi.obj res\OPL3GM.res bufferoverflowU.lib kernel32.lib user32.lib /nologo /dll /def:".\res\vstplug.def" /OUT:OPL3Apogee_IA64.dll
link audioeffect.obj audioeffectx.obj vstplugmain.obj main.obj midiprog.obj OPL3GM.obj OPL3GM_proc.obj queue.obj DCFilter.obj resampler.obj opl.obj opl3.obj opl3class.obj i_oplmusic.obj res\OPL3GM.res bufferoverflowU.lib kernel32.lib user32.lib /nologo /dll /def:".\res\vstplug.def" /OUT:OPL3Doom_IA64.dll
link audioeffect.obj audioeffectx.obj vstplugmain.obj main.obj midiprog.obj OPL3GM.obj OPL3GM_proc.obj queue.obj DCFilter.obj resampler.obj opl.obj opl3.obj opl3class.obj opl3midi.obj res\OPL3GM.res bufferoverflowU.lib kernel32.lib user32.lib /nologo /dll /def:".\res\vstplug.def" /OUT:OPL3W9x_IA64.dll
del *.exp *.lib *.obj
del res\OPL3GM.res
iscc /Qp "install.iss"
